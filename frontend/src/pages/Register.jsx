...
const Register = () => {
  return (
    <div className="bg-gradient-to-tr from-[#f6d365] to-[#fda085] h-screen flex items-center justify-center overflow-hidden">
      <div className="bg-white shadow-md rounded-lg p-8 max-w-md w-full">
        <h1 className="text-2xl font-semibold text-black mb-6">Register to Continue</h1>
